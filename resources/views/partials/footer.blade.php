<footer class="bg-zinc-50 border-t border-zinc-200 mt-20" dir="rtl">
    <div class="max-w-7xl mx-auto px-6 py-12 lg:py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            {{-- Quick Links --}}
            <div class="lg:col-span-2 flex flex-col items-center md:items-start text-center md:text-right">
                <h3 class="text-zinc-900 font-bold text-lg mb-6 relative inline-block">
                    روابط سريعة
                    <span class="absolute -bottom-2 right-0 w-1/2 h-1 bg-[#498E49] rounded-full"></span>
                </h3>
                <ul class="space-y-4">
                    <li>
            ...
            {{-- Contact Info & Social --}}
            <div class="lg:col-span-3 flex flex-col items-center md:items-start text-center md:text-right">
                <h3 class="text-zinc-900 font-bold text-lg mb-6 relative inline-block">
                    تواصل معنا
                    <span class="absolute -bottom-2 right-0 w-1/2 h-1 bg-[#498E49] rounded-full"></span>
                </h3>
                <ul class="space-y-4 mb-8">
                    <li class="flex items-center gap-3 text-zinc-600 justify-center md:justify-start">
                        <svg class="w-5 h-5 text-[#498E49]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>
                        <a href="tel:966564364261" class="dir-ltr hover:text-[#498E49] transition-colors">056 436
                            4261</a>
                    </li>
                    <li class="flex items-center gap-3 text-zinc-600 justify-center md:justify-start">
                        <svg class="w-5 h-5 text-[#498E49]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="mailto:info@kayanalnhda.com"
                            class="hover:text-[#498E49] transition-colors">info@kayanalnhda.com</a>
                    </li>
                    <li class="flex items-center gap-3 text-zinc-600 justify-center md:justify-start">
                        <svg class="w-5 h-5 text-[#498E49]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
