                ...
                <div class="border-b border-neutral-700 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" wire:model="map_url" placeholder="مثال: https://maps.google.com/..."
                                class="w-full p-3 rounded-xl bg-neutral-900 border border-neutral-600 text-gray-200 placeholder-neutral-500 focus:border-[#498e49] focus:ring focus:ring-[#498e49]/20 outline-none transition-all">
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            @if ($existingPdf)
                                <div class="text-xs text-gray-400 flex items-center gap-1 mt-1">
                                    ...
                                    <a href="{{ asset('storage/' . $existingPdf) }}" target="_blank"
                                        class="text-[#498e49] hover:underline font-bold">عرض ملف الـ PDF الحالي</a>
                                </div>
                            @endif
                        </div>
                    </div>
