                    ...
                    <div x-data="{ open: false }" class="bg-neutral-700/50 p-3 rounded-xl text-gray-200">
                        <div @click="open = !open" class="flex justify-between items-center cursor-pointer">
                            ...
                            <svg :class="{ 'rotate-90': open }"
                                class="w-4 h-4 text-[#498e49] transform transition-transform duration-200"
                            ...
                            @if ($project->properties->isNotEmpty())
                                <div class="flex flex-col gap-1">
                                    @foreach ($project->properties as $property)
                                        <div
                                            class="flex justify-between items-center bg-neutral-600/50 p-2 rounded-lg text-gray-200 hover:bg-[#498e49] hover:text-white transition-all duration-200 group">
                                            <span
                                                class="font-medium cursor-pointer flex-grow">{{ $property->name }}</span>
        ...
        <div class="bg-neutral-800 rounded-2xl shadow-sm border border-neutral-700 p-8">
            ...
            @if (session()->has('message'))
                <div class="fixed top-4 right-4 z-50 w-full max-w-sm" x-data="{ show: true }" x-show="show"
                    x-init="setTimeout(() => show = false, 5000)">
                    <div
                        class="bg-[#498e49]/90 backdrop-blur-sm text-white p-4 rounded-xl mb-6 border border-[#498e49]/50 shadow-xl flex items-center justify-between">
            ...
            <div class="flex flex-col gap-8">
                ...
                <div class="pt-4 border-t border-neutral-700 flex justify-end">
                    <button wire:click="createProperties" wire:loading.attr="disabled"
