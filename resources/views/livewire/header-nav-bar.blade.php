<nav x-data="{ open: false }" class="top-0 z-50 w-full mx-auto px-4 py-3 container">
    ...
    <div class="flex justify-between items-center max-md:[direction:rtl]">
        ...
        <div class="hidden md:flex items-center space-x-8 ">
            <a href="{{ route('welcome') }}"
                ...
                wire:current="text-[#498E49] font-bold" wire:navigate.hover>
                الرئيسية
                <span
        ...
        <div class="md:hidden flex items-center">
            <button @click="open = !open" type="button"
                class="text-gray-600 hover:text-[#498E49] focus:outline-none p-2 rounded-md transition-colors">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        class="md:hidden mt-4 pb-4 border-t border-gray-100 dark:border-neutral-800" style="display: none;">
        <div
            class="flex fixed top-0 right-0 w-full flex-col space-y-3 pt-4 px-2 rounded-2xl text-right bg-[#f5fdf5] text-[#498E49]">
            <a href="{{ route('welcome') }}" wire:navigate
                class="text-gray-600 hover:text-[#498E49] font-medium block px-3 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors">
                الرئيسية
            </a>
            ...
            <div @click="open = false"
                class="text-gray-600 text-center hover:text-[#498E49] block px-3 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors">
