...
@section('main')
    <div class="container mx-auto px-4 py-8 rtl" dir="rtl">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <span>/</span>
            <a href="{{ route('project', $properties->project->id) }}" class="hover:text-[#498e49]">{{ $properties->project->name }}</a>
            <span>/</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="swiper-wrapper">
                                @foreach($properties->propertiesImages as $image)
                                    <div class="swiper-slide">
                                        <img src="{{ asset('storage/' . $image->url) }}" alt="{{ $properties->name }}" class="w-full h-full object-cover">
                                    </div>
                                @endforeach
                            </div>
                            <div class="swiper-button-next !text-white !w-10 !h-10 !bg-black/20 hover:!bg-black/50 !rounded-full !hidden group-hover:!flex after:!text-lg"></div>
                            <div class="swiper-button-prev !text-white !w-10 !h-10 !bg-black/20 hover:!bg-black/50 !rounded-full !hidden group-hover:!flex after:!text-lg"></div>
            ...
            <div class="flex gap-4 items-center justify-center">
                ...
                <div class="w-6/12 relative rounded-3xl overflow-hidden shadow-xl bg-gray-100 aspect-video group">
                    <iframe class="absolute top-0 left-0 w-full h-full" 
                            src="{{ $properties->stages_building_youtube }}" 
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-y-6 gap-x-4 text-center md:text-right">
                        ...
                        <div class="p-4 bg-gray-50 rounded-xl">
                         ...
                         <div class="p-4 bg-gray-50 rounded-xl">
                            ...
                            <span class="font-bold text-[#498e49] text-lg">{{ number_format($properties->price) }} ريال</span>
                        </div>
                         <div class="p-4 bg-gray-50 rounded-xl">
            ...
            <div class="space-y-6">
                 ...
                 <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                    ...
                    <ul class="space-y-3">
                         <li class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-gray-800 bg-gray-100 px-3 py-1 rounded-full text-sm">{{ $properties->parkings }}</span>
                        </li>
                         <li class="flex justify-between items-center">
                            <span class="text-gray-600">غرفة سائق</span>
                            <span class="font-bold text-gray-800 bg-gray-100 px-3 py-1 rounded-full text-sm">{{ $properties->driver_room }}</span>
                        </li>
                         <li class="flex justify-between items-center">
                            <span class="text-gray-600">مؤثثة</span>
                            <span class="font-bold {{ $properties->furniture ? 'text-[#498e49]' : 'text-gray-400' }} bg-gray-100 px-3 py-1 rounded-full text-sm">
                ...
                <div class="bg-gradient-to-br from-[#498e49] to-[#3d7a3d] rounded-2xl shadow-lg p-6 text-white text-center">
                    <h3 class="font-bold text-xl mb-2">مهتم بهذا العقار؟</h3>
                    <p class="text-white/80 text-sm mb-6">تواصل معنا الآن للحصول على مزيد من المعلومات أو لحجز موعد للمعاينة.</p>
                    <button class="w-full bg-white text-[#498e49] font-bold py-3 rounded-xl hover:bg-gray-50 transition-colors shadow-sm">
                        تواصل معنا
                    </button>
                </div>
