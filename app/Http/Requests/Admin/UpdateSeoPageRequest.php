...
class UpdateSeoPageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Only the types a link preview actually distinguishes; a free
            // string here would be copied into og:type and quietly ignored.
            'og_type' => ['nullable', Rule::in(['website', 'article', 'profile'])],
            'noindex' => 'boolean',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'og_type.in' => 'نوع المحتوى غير معروف.',
        ];
    }
}
